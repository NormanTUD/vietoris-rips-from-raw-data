...
def make_complex(simplices: list[tuple], values: list[float], kind: str = "test") -> FilteredComplex:
...
def test_triangle_persistent_loop():
    fc = triangle_complex()
...
def test_torus_two_essential_loops():
...
def test_two_disjoint_circles_two_loops():
...
def test_filled_triangle_no_essential_loop():
